...
public partial class DoorAnimModel 
{
    ...
    [RealtimeProperty(1, false, true)] private int _openCloseDoor;
...
public partial class DoorAnimModel : RealtimeModel {
    ...
    public event PropertyChangedHandler<int> openCloseDoorDidChange;
    ...
    private UnreliableProperty<int> _openCloseDoorProperty;
    
    #endregion
    
    public DoorAnimModel() : base(null) {
        _openCloseDoorProperty = new UnreliableProperty<int>(1, _openCloseDoor);
    }
    
    private void FireOpenCloseDoorDidChange(int value) {
        try {
