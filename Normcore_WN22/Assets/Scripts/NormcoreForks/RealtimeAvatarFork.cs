...
namespace Normal.Realtime
{
    ...
    public class RealtimeAvatarFork : RealtimeComponent<RealtimeAvatarModel>
    {
        // Local Player
        [Serializable]
...
#pragma warning restore 0649
        ...
        {
            get => (DeviceType)model.deviceType;
            set => model.deviceType = (RealtimeAvatar.DeviceType)value;
        }
...
#pragma warning restore 0649
        ...
        private RealtimeAvatarManagerFork _realtimeAvatarManager;
        ...
        void Start()
        {
            ...
            try
            {
                _realtimeAvatarManager = GameObject.Find("Realtime + VR Player").GetComponent<RealtimeAvatarManagerFork>();
